      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <div class="page-content my-account__dashboard">
            ...
            <p>From your account dashboard you can view your <a class="unerline-link" href="{{ route('order') }}">recent
                orders</a>, manage your <a class="unerline-link" href="{{ route('new') }}">shipping
                addresses</a>, and <a class="unerline-link" href="{{ route('change') }}">edit your password and account
                details.</a></p>
          </div>
        </div>
      </div>
